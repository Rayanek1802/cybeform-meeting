...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-14 px-6 text-left align-middle font-semibold text-gray-700 text-sm tracking-wide uppercase border-b border-gray-200 first:rounded-tl-xl last:rounded-tr-xl",
...
>(({ className, icon, highlight = false, children, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-6 py-4 align-middle text-gray-800 font-medium border-b border-gray-100 last:border-r-0",
